 ...
 <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <?php $sql = mysqli_query($con, "SELECT tenure,ctype,doj,vdate,apartment FROM tbl_demo_data WHERE id = '".$_SESSION['userID']."' ");
         ...
         <div class="col-lg-12">
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        { 
                                            ?>
                                    <?php $sql3 = mysqli_query($con,"SELECT * FROM tbl_demo_data WHERE id='".$_SESSION['userID']."'");
