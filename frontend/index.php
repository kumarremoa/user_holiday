...
$password = $_POST['password'];
	$sql = mysqli_query($con, "select count(*) as num, id, email from tbl_member_data where email='".$email."' and password='".$password."' and status='1'");
                    ...
                    <div class="panel-body">
                        <form role="form" name="frm" id="frm" method="post">
                            <fieldset>
                                ...
                                <p id="submit1" class="btn btn-lg btn-success btn-block">Login</p>
                            </fieldset>
                        </form>
                    </div>
                </div>
