 ...
 <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
					...
					<?php $sql = mysqli_query($con, "select bal from tbl_member_data where id='".$_SESSION['userID']."'");
         ...
         <div class="col-lg-12">
             <div class="panel panel-default">
             	<div class="panel-heading">
							 ...
							 <p>Total Balance: <?php echo $total_balnce;?></p>
							 <p>Remaining Balance: <?php echo $total_balnce-$pay_balnce;?></p>
                        </div>
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
									<?php $sql = mysqli_query($con,"select * from tbl_mamberpayment where member_id='".$_SESSION['userID']."'");
