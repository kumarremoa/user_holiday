...
<div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <?php
            $sql = mysqli_query($con, "SELECT tenure,ctype,doj,vdate,apartment,days FROM tbl_member_data WHERE id = '" . $_SESSION['userID'] . "' ");
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                for ($i = 1; $i <= $tenure; $i++) {
                                    ?>
                                    <?php
                                    $sql3 = mysqli_query($con, "SELECT * FROM tbl_member_data WHERE id='" . $_SESSION['userID'] . "'");
                                        ...
                                        ?></td>
                                            <td>
                                                ...
                                                if ($current_date >= $valid_from && $current_date <= $valid_to) {
                                                    ?>
                                                    <a href="booking.php"><button class="btn btn-success">Book</button></a>
